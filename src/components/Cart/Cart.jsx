  ...
  document.addEventListener('DOMContentLoaded', function() {
   ...
   return (  
        ...
        <div className="container">
                  ...
                  <div id="emptyCartMessage" style={{ display: cartEmpty ? "block" : "none",textAlign:"center"}}  className="w-3/4 p-4 bg-white m-2 " >
                    <img style={{textAlign:"center",marginLeft:"400px"}} src="https://www.jumia.com.eg/assets_he/images/cart.668e6453.svg"></img>
                    <h3>Your cart is emptey!</h3>
                    <p>Browse our categories and discover our best deals!</p>
                    <button  className="button bg-orange-600 w-4/4 hover:bg-orange-700 text-white m-4 font-bold py-2 px-6 rounded focus:outline-none focus:shadow-outline"><a href="/home">Start Shopping</a></button>
                    </div>

          <div id="cartContainer" style={{ display: cartEmpty ? "none" : "block" }}>
